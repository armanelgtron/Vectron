...
class Step extends Evented {
  ...
  render() {
    ...
    if (this.options.showCancelLink) {
      if(isUndefined(this.options.cancelLinkText)) {
          this.options.cancelLinkText = "✕";
      }
      const link = createFromHTML("<a href class='shepherd-cancel-link'>"+this.options.cancelLinkText+"</a>");
